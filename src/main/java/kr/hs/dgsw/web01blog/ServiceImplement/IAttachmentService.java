...
public class IAttachmentService implements AttachmentService {
    ...
    @Override
    public boolean UploadAttachemnt(MultipartFile file, Long postedId) {
        try{
            ...
            attachment.setPostId(postedId);
            attachment.setStoredPath(destFilename);
    ...
    @Override
    public void DownLoadAttachement(List<Attachment> attachmentList, HttpServletRequest request, HttpServletResponse response) {
        ...
        try{
            for (Attachment attachment:attachmentList) {
                String filepath = attachment.getStoredPath();
            ...
            System.out.println("Print Attachment DONE!");
        }catch (Exception e){
            return;
        }
    }
